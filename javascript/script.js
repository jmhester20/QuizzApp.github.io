...
const showQuizResult = () => {
  ...
  // 1) Create an <img> tag for your HokieBird
  const birdImg = '<img src="images/HokieBird3.png" alt="Hokie Bird" class="result-bird" />';

  // 2) Prepend that image to your result text
  const resultText =
 
    `You got <b>${correctAnswersCount}</b> out of <b>${numberOfQuestions}</b> questions correct. Thanks for Playing! `;
